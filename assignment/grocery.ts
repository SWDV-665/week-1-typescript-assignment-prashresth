...
let item_milk = new Grocery("Milk", "Freshest Milk from local farms.", 3, 3.50);
let item_eggs = new Grocery("Eggs", "Organic eggs.", 5, 2.50);
let item_bread = new Grocery("Bread", "Classic white bread.", 8, 1.99);
let item_cheese = new Grocery("Cheese", "Cheddar cheese slices.", 6, 5.49);
